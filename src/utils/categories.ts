//* Aqui vaos simular as categorias da categorySelect
...
export const categories = [
  ...
  { id: '2', title: 'Ranqueada', icon: DuelSvg },
  { id: '3', title: 'Ranqueada', icon: FunSvg },
  { id: '4', title: 'Ranqueada', icon: TrainingSvg },
];
